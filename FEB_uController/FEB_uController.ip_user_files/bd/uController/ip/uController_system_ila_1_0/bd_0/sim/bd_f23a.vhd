...
----------------------------------------------------------------------------------
--Command: generate_target bd_f23a.bd
--Design : bd_f23a
...
entity bd_f23a is
  ...
  attribute CORE_GENERATION_INFO of bd_f23a : entity is "bd_f23a,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_f23a,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of bd_f23a : entity is "uController_system_ila_1_0.hwdef";
end bd_f23a;

architecture STRUCTURE of bd_f23a is
  component bd_f23a_ila_lib_0 is
  port (
    clk : in STD_LOGIC;
    probe0 : in STD_LOGIC_VECTOR ( 15 downto 0 )
  );
  end component bd_f23a_ila_lib_0;
...
ila_lib: component bd_f23a_ila_lib_0
     port map (
      clk => clk_1,
