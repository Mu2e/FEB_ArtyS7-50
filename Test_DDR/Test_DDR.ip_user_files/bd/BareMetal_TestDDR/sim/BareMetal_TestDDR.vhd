...
entity BareMetal_TestDDR is
  ...
  attribute CORE_GENERATION_INFO of BareMetal_TestDDR : entity is "BareMetal_TestDDR,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=BareMetal_TestDDR,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=3,numReposBlks=3,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}";
...
architecture STRUCTURE of BareMetal_TestDDR is
  component BareMetal_TestDDR_clk_wiz_0_2 is
  port (
    resetn : in STD_LOGIC;
  ...
  end component BareMetal_TestDDR_clk_wiz_0_2;
  component BareMetal_TestDDR_clk_wiz_1_1 is
  port (
    resetn : in STD_LOGIC;
    clk_in1 : in STD_LOGIC;
    clk_out1 : out STD_LOGIC;
  ...
  end component BareMetal_TestDDR_clk_wiz_1_1;
  ...
  attribute X_INTERFACE_PARAMETER of sys_clock : signal is "XIL_INTERFACENAME CLK.SYS_CLOCK, CLK_DOMAIN BareMetal_TestDDR_sys_clock, FREQ_HZ 12000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0";
begin
...
clk_wiz_0: component BareMetal_TestDDR_clk_wiz_0_2
     port map (
      clk_in1 => sys_clock_1,
...
clk_wiz_1: component BareMetal_TestDDR_clk_wiz_1_1
     port map (
